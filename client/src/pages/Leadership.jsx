...
export default function LeadershipMessage() {
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-gradient-to-br py-10 from-blue-900 via-purple-900 to-indigo-900">
        <motion.div
          initial="hidden"
          animate="visible"
            ...
            <div className="grid lg:grid-cols-3 gap-8 p-8 md:p-12">
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <motion.div variants={itemVariants} className="text-lg leading-relaxed text-gray-700 space-y-6">
                  <p>
                    Welcome to <span className="font-semibold text-blue-800">Saroj International University (SIU)</span>, where knowledge meets innovation and leadership is forged through purpose. SIU stands tall as a modern institution dedicated to shaping futures, transforming societies, and empowering students to lead in a dynamic world.
                  </p>

                  <p>
                    At SIU, education transcends the traditional. We emphasize experiential learning, research-driven thinking, and a values-based approach to leadership. Our globally-aware faculty and cutting-edge facilities provide a vibrant ecosystem where academic excellence meets personal transformation.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-xl italic text-blue-800 font-medium leading-relaxed">
                    "Our vision at SIU is not just to educate but to inspire — to cultivate minds that will question, explore, and lead with integrity."
                  </p>
                </motion.div>

                <motion.div variants={itemVariants} className="text-lg leading-relaxed text-gray-700">
                  <p>
                    The leadership at SIU is committed to nurturing a community of learners who are not only career-ready but also socially conscious global citizens. We welcome you to be part of this exciting journey — a journey of vision, courage, and transformation.
                  </p>
                </motion.div>

                {/* Signature Section */}
                <motion.div variants={itemVariants} className="mt-12 pt-8 border-t-2 border-gray-200">
                  <p className="text-lg italic text-gray-600 mb-6">With Purpose and Passion,</p>
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{ width: "200px" }}
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 font-medium">Founder & Visionary Leader, SIU</p>
                  </div>
                </motion.div>
              </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-2xl shadow-lg h-full">
                  ...
                  <motion.div variants={itemVariants} className="text-center space-y-4">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Pioneering Saroj International University with integrity, foresight, and over two decades of leadership in education.
                    </p>
